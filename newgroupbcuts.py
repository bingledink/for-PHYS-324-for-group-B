...
for event_idx in range(len(elec_pt)):
    ...
    mu4vector.SetPtEtaPhiM((muon_pt[event_idx][mu_index]), (muon_eta[event_idx][mu_index]),
                           (muon_phi[event_idx][mu_index]), (muon_mass[event_idx][mu_index]))
...
tree.Branch("weight_ones", weight_ones_arr, "weight_ones[weight_size]/F")

tree.Branch("jet_size", jet_size_arr, "jet_size/I")
tree.Branch("jet_pt_ones", jet_pt_ones_arr, "jet_pt_ones[jet_size]/F")
tree.Branch("jet_eta_ones", jet_eta_ones_arr, "jet_eta_ones[jet_size]/F")
tree.Branch("jet_phi_ones", jet_phi_ones_arr, "jet_phi_ones[jet_size]/F")
tree.Branch("jet_mass_ones", jet_mass_ones_arr, "jet_mass_ones[jet_size]/F")
tree.Branch("jet_btag_ones", jet_btag_ones_arr, "jet_btag_ones[jet_size]/F")

tree.Branch("genjet_size", genjet_size_arr, "genjet_size/I")
tree.Branch("genjet_pt_ones", genjet_pt_ones_arr, "genjet_pt_ones[genjet_size]/F")
tree.Branch("genjet_eta_ones", genjet_eta_ones_arr, "genjet_eta_ones[genjet_size]/F")
tree.Branch("genjet_phi_ones", genjet_phi_ones_arr, "genjet_phi_ones[genjet_size]/F")
tree.Branch("genjet_mass_ones", genjet_mass_ones_arr, "genjet_mass_ones[genjet_size]/F")

tree.Branch("genpart_size", genpart_size_arr, "genpart_size/I")
tree.Branch("genpart_pt_ones", genpart_pt_ones_arr, "genpart_pt_ones[genpart_size]/F")
tree.Branch("genpart_eta_ones", genpart_eta_ones_arr, "genpart_eta_ones[genpart_size]/F")
tree.Branch("genpart_phi_ones", genpart_phi_ones_arr, "genpart_phi_ones[genpart_size]/F")
tree.Branch("genpart_mass_ones", genpart_mass_ones_arr, "genpart_mass_ones[genpart_size]/F")
tree.Branch("genpart_charge_ones", genpart_charge_ones_arr, "genpart_charge_ones[genpart_size]/F")
tree.Branch("genpart_status_ones", genpart_status_ones_arr, "genpart_status_ones[genpart_size]/F")
tree.Branch("genpart_pid_ones", genpart_pid_ones_arr, "genpart_pid_ones[genpart_size]/F")
...
for i in range(len(e_pt)):
    ...
    weight_size_arr[0] = len(weight_ones[i])
    jet_size_arr[0] = len(jet_pt[i])
    genjet_size_arr[0] = len(genjet_pt_ones[i])
    genpart_size_arr[0] = len(genpart_pt_ones[i])

    for v in range(weight_size_arr[0]):
        weight_ones_arr[v] = weight_ones[i][v]

    for v in range(genjet_size_arr[0]):
    ...
    for v in range(genpart_size_arr[0]):
        ...
        genpart_mass_ones_arr[v] = genpart_mass_ones[i][v]
        genpart_charge_ones_arr[v] = genpart_charge_ones[i][v]
        genpart_pid_ones_arr[v] = genpart_pid_ones[i][v]
        genpart_status_ones_arr[v] = genpart_status_ones[i][v]
    for v in range(jet_size_arr[0]):
